...
and lowercase SHA-256 checksums. The 2026 parquet input is complete only when
both the pitch and event timelines are present:

```json
{"schema_version":1,"version":"za-2026.09.1","seasons":{"2026":{"path":"pitches.parquet","sha256":"<64 hex characters>","events_path":"events.parquet","events_sha256":"<64 hex characters>"}}}
```
